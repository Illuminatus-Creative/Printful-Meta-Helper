...
final class PMH_Admin_Help {
	...
	public static function strings(): array {
		return array(
			...
			'materials_paste'     => __( 'Paste Printful\'s bullet list from the product description. On save the first line containing "%" becomes the base material, further "%" lines become colour exceptions, the "Fabric weight" line becomes the weight, and every other bullet becomes construction. Sourcing and disclaimer lines are dropped. The fields above are replaced, and remain editable afterwards.', 'printful-meta-helper' ),
			// Size chart imports.
